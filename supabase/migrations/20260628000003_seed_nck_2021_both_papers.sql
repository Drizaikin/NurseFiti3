...
INSERT INTO questions (cadre,paper,unit,topic,stem,option_a,option_b,option_c,option_d,correct_option,rationale,difficulty,exam_year,status,contributor_id)
VALUES('KRCHN','Paper I','Medical-Surgical Nursing','Neurological Disorders','The clinical presentation of a brain abscess in the frontal lobe includes:-','Expressive aphasia, facial weakness and hemiparesis','Expressive aphasia, hemiparesis and headache','Occipital headache, hemiparesis and ataxia','Facial weakness, headache and hemiparesis','B','Headache from raised intracranial pressure is the most universal and prominently presenting feature of any brain abscess, making B the most complete and diagnostically accurate triad. Facial weakness can occur but is less consistent.','easy',2021,'approved',NULL)ON CONFLICT(stem,cadre)DO NOTHING;
...
INSERT INTO questions (cadre,paper,unit,topic,stem,option_a,option_b,option_c,option_d,correct_option,rationale,difficulty,exam_year,status,contributor_id)
VALUES('KRCHN','Paper I','Medical-Surgical Nursing','Respiratory Disorders','The rate of oxygen administered to a chronic emphysema patient is:','10 L/minute','5 L/minute','2 L/minute','7 L/minute','C','The key principle is targeting SpO2 88–92% with controlled low-flow oxygen in COPD type II. The NCK curriculum specifies 2 L/min as the standard teaching answer; in practice, the rate is titrated to achieve this target.','easy',2021,'approved',NULL)ON CONFLICT(stem,cadre)DO NOTHING;
