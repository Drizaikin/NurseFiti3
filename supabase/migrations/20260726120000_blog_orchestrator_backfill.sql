-- Paste this whole file into the Supabase SQL editor for project wnfbjyfenvdofvfcxnzk.
-- blog_posts (20260718000001) is already applied. This adds the two missing pieces:
--   1. blog_draft_ingestions  (20260719000002)
--   2. draft_doc_url column   (20260725000003)
...
begin
  alter table public.blog_draft_ingestions
    add constraint blog_draft_ingestions_doc_url_check
