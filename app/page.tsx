...
const getPricing = (settings: PlatformSettings) => [
  ...
  },
  {
    ...
    features: ['200 practice questions/day', '7-day access', 'AI explanations', '3 mock exams (2 downloads)', 'Flashcards and analytics', 'Personalized revision plan included', 'Download incorrect questions'],
  ...
  },
  {
    ...
    features: ['Unlimited MCQ practice', '3 mock exams/week (unlimited downloads)', 'Smarter analytics', 'Adaptive revision roadmap', 'Flashcards', 'Tutor priority', 'Download incorrect questions'],
  ...
  },
  {
    ...
    features: ['Everything in Success Plan', 'Unlimited mock exams & downloads', 'Tutor priority', 'Exam registration reminders', 'Download incorrect questions'],
    cta: 'Join Elite Prep',
    href: '/signup',
    highlight: false,
    badge: 'Best Value',
