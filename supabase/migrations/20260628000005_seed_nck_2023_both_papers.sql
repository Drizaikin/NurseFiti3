...
INSERT INTO questions (cadre,paper,unit,topic,stem,option_a,option_b,option_c,option_d,correct_option,rationale,difficulty,exam_year,status,contributor_id)
VALUES('KRCHN','Paper II','Health Systems & Management','Professional Ethics','In case of an assault, the P3/PRC form distribution is:','The original form remains with the police','The triplicate form remains with the victim','The duplicate form remains with the hospital','The original form remains with the victim','D','CLINICAL/MEDICO-LEGAL NOTE: There is a distinction between the Police Medical Examination (P3) form and the Post-Rape Care (PRC) form. The original P3 form remains with the police, while the original PRC form remains with the victim/survivor. Because this question combines them ("P3/PRC"), the NCK key maps to D (original to victim), reflecting the modern prioritisation of the PRC form in sexual/gender-based violence guidelines.','easy',2023,'approved',NULL)ON CONFLICT(stem,cadre)DO NOTHING;

INSERT INTO questions (cadre,paper,unit,topic,stem,option_a,option_b,option_c,option_d,correct_option,rationale,difficulty,exam_year,status,contributor_id)
VALUES('BScN','Paper II','Nursing Management & Leadership','Professional Ethics','In case of an assault, the P3/PRC form distribution is:','The original form remains with the police','The triplicate form remains with the victim','The duplicate form remains with the hospital','The original form remains with the victim','D','CLINICAL/MEDICO-LEGAL NOTE: There is a distinction between the Police Medical Examination (P3) form and the Post-Rape Care (PRC) form. The original P3 form remains with the police, while the original PRC form remains with the victim/survivor. Because this question combines them ("P3/PRC"), the NCK key maps to D (original to victim), reflecting the modern prioritisation of the PRC form in sexual/gender-based violence guidelines.','easy',2023,'approved',NULL)ON CONFLICT(stem,cadre)DO NOTHING;
...
INSERT INTO questions (cadre,paper,unit,topic,stem,option_a,option_b,option_c,option_d,correct_option,rationale,difficulty,exam_year,status,contributor_id)
VALUES('KRCHN','Paper I','Midwifery','Family Planning','A woman who smokes uses which WHO medical eligibility criteria category for combined oral contraceptives?','Category 1','Category 2','Category 3','Category 4','B','Note: The stem lacks age details. For a smoker under 35 years, COC use is WHO MEC Category 2. For smokers aged 35+ who smoke <15 cigarettes/day, it is Category 3. For smokers aged 35+ who smoke >=15 cigarettes/day, it is Category 4. The NCK key assumes a young woman (<35).','easy',2023,'approved',NULL)ON CONFLICT(stem,cadre)DO NOTHING;
