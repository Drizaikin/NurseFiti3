      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid gap-4">
          {[
            ...
            { q: 'My M-Pesa payment went through but my plan wasn\'t activated', a: 'Please wait 2–3 minutes and refresh. If still not activated, email support@nursefiti.vercel.app with your M-Pesa receipt number.' },
