  ...
  return (
    <div className="space-y-5 pb-24 lg:pb-6 max-w-5xl mx-auto">
      <div>
        ...
        <p className="text-sm text-[var(--color-text-secondary)] mt-1">All amounts in KSh. Platform fee: 23% · You keep 77%. Payouts every Monday.</p>
      </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-[var(--color-text-secondary)] mt-1">
              Gross → 23% platform fee → You receive 77%: KSh {Math.round(data.ratePerHour * 0.77).toLocaleString()}/hr
            </p>
          </div>
