...
<title>NCK Revision Plan — ${studentName}</title>
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .day-header { display: flex; align-items: center; gap-6px; flex-wrap: wrap; gap: 4px; margin-bottom: 8px; }
...
<div class="container">
  ...
  <div class="plan-header">
    ...
    <p class="subtitle">Personalised for ${studentName} · Generated by NurseFiti</p>
    <div class="plan-meta">
      <div class="plan-meta-item"><strong>${cadre}</strong>Cadre</div>
