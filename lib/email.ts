...
// ─── Utility exports (unchanged signatures) ───────────────────────────────────
    ...
    <tr>
      <td style="background:#ffffff;padding:36px 36px 0;">
        <h2 style="font-family:Arial,sans-serif;font-size:21px;font-weight:700;color:#08514F;margin:0 0 14px;">
          Welcome, <span style="color:#F5A623;">${safeFirst}!</span> 🎉
        </h2>
        ...
        <div style="border-top:2px solid #D0E8E7;padding-top:18px;">
          <table cellpadding="0" cellspacing="0"><tr>
            ...
            <td style="vertical-align:middle;">
              ...
              <div style="font-size:11.5px;color:#4A6868;margin-top:2px;">Reply to this email — a real person will get back to you.</div>
            </td>
          </tr></table>
        </div>
      </td>
...
${supportEmail}`;
  ...
  return sendEmail(
    params.to,
    'Welcome to NurseFiti — Your journey starts now',
    text,
    undefined,
    ...
    <tr>
      <td style="background:#ffffff;padding:36px 36px 28px;">
        ...
        <p style="font-size:14.5px;color:#1E3535;line-height:1.75;margin:0 0 24px;">
          Your NurseFiti subscription is now <strong style="color:#08514F;">active</strong>. You have full access to all features included in your plan — start studying smarter today.
        </p>
...
function buildSessionBookingStudentHtml(params: SessionEmailParams): string {
  ...
  return emailWrapper(`
    <tr>
      <td style="background:#ffffff;padding:36px 36px 28px;">
        <h2 style="font-family:Arial,sans-serif;font-size:21px;font-weight:700;color:#08514F;margin:0 0 8px;">
          Session Confirmed, <span style="color:#F5A623;">${safeName}!</span> ✅
        </h2>
        <p style="font-size:14.5px;color:#1E3535;line-height:1.75;margin:0 0 24px;">
...
function buildReminderTutorHtml(params: SessionEmailParams, timeUntil: string): string {
  ...
  return emailWrapper(`
    <tr>
      <td style="background:#ffffff;padding:36px 36px 28px;">
        <h2 style="font-family:Arial,sans-serif;font-size:21px;font-weight:700;color:#08514F;margin:0 0 8px;">
          â° Session Reminder — Starting in <span style="color:#F5A623;">${safeTime2}</span>
        </h2>
        <p style="font-size:14.5px;color:#1E3535;line-height:1.75;margin:0 0 24px;">
    ...
    <tr>
      <td style="background:#ffffff;padding:36px 36px 28px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
              <td style="vertical-align:top;">
                ...
                <div style="font-family:Arial,sans-serif;font-size:16px;font-weight:700;color:white;margin-bottom:6px;">${safeType} — 90 Days</div>
        ...
        <div style="background:#F2FAFA;border:1.5px solid #D0E8E7;border-left:4px solid #08514F;border-radius:10px;padding:20px 22px;margin-bottom:20px;">
          ...
          <table width="100%" cellpadding="0" cellspacing="0">
            <tr><td style="font-size:13px;color:#4A6868;padding-bottom:10px;">✅</td><td style="font-size:13px;color:#1E3535;padding-bottom:10px;padding-left:8px;">Unlimited mock exams mirroring the real NCK format</td></tr>
            <tr><td style="font-size:13px;color:#4A6868;padding-bottom:10px;">✅</td><td style="font-size:13px;color:#1E3535;padding-bottom:10px;padding-left:8px;">Full 2,400+ question bank with detailed rationales</td></tr>
            <tr><td style="font-size:13px;color:#4A6868;padding-bottom:10px;">✅</td><td style="font-size:13px;color:#1E3535;padding-bottom:10px;padding-left:8px;">AI-powered nursing tutor assistant</td></tr>
            <tr><td style="font-size:13px;color:#4A6868;padding-bottom:10px;">✅</td><td style="font-size:13px;color:#1E3535;padding-bottom:10px;padding-left:8px;">Personal performance analytics &amp; insights</td></tr>
            <tr><td style="font-size:13px;color:#4A6868;">✅</td><td style="font-size:13px;color:#1E3535;padding-left:8px;">Spaced-repetition flashcard system</td></tr>
          </table>
        </div>
        <div style="text-align:center;margin-bottom:28px;">
