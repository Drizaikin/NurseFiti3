...
INSERT INTO questions (cadre,paper,unit,topic,stem,option_a,option_b,option_c,option_d,correct_option,rationale,difficulty,exam_year,status,contributor_id)
VALUES('KRCHN','Paper I','Midwifery','Antenatal Care','Which activities are performed on the 2nd focused ANC visit?','Review obstetric issues that may occur in the current pregnancy','Carry out VDRL','Do rhesus factor and blood group','Do a random blood sugar','A','This answer reflects the old FANC 4-visit model. Under the current WHO 2016 / Kenya 8-contact ANC model, different activities apply at the 2nd contact (20 weeks). Students must know both models for the NCK CBT.','easy',2022,'approved',NULL)ON CONFLICT(stem,cadre)DO NOTHING;
...
INSERT INTO questions (cadre,paper,unit,topic,stem,option_a,option_b,option_c,option_d,correct_option,rationale,difficulty,exam_year,status,contributor_id)
VALUES('KRCHN','Paper II','Community Health Nursing','Nutrition','Which of the following fruits is a source of calcium?','Oranges','Bananas','Tomatoes','Avocados','A','Among the options, oranges have the highest calcium content (~43 mg/100g). Major sources are dairy and leafy greens. Note: oranges are primarily known as a Vitamin C source but are included in Kenya''s plant-based calcium guidance.','easy',2022,'approved',NULL)ON CONFLICT(stem,cadre)DO NOTHING;
...
INSERT INTO questions (cadre,paper,unit,topic,stem,option_a,option_b,option_c,option_d,correct_option,rationale,difficulty,exam_year,status,contributor_id)
VALUES('KRCHN','Paper I','Paediatric Nursing','Neonatal Assessment','An infant at 5 minutes of life has: pulse 95/min, cyanotic hands and feet, some flexion of extremities, irregular breathing. The APGAR score is:','7','8','9','10','A','Note: The stem does not explicitly state the grimace/reflex irritability score (5th APGAR criterion). The score of 7 assumes grimace = 2 (vigorous cry). Students should flag this as an incomplete stem from the original NCK paper.','easy',2022,'approved',NULL)ON CONFLICT(stem,cadre)DO NOTHING;
...
INSERT INTO questions (cadre,paper,unit,topic,stem,option_a,option_b,option_c,option_d,correct_option,rationale,difficulty,exam_year,status,contributor_id)
VALUES('KRCHN','Paper II','Community Health Nursing','Communicable Diseases','Which of the following is a zoonotic disease?','Toxoplasmosis','Tetanus','Gonorrhoea','Plague','D','Note: Both toxoplasmosis (A) and plague (D) are zoonotic diseases. The NCK source paper keys D (plague) as the expected answer. Students should be aware that toxoplasmosis is also a zoonosis.','easy',2022,'approved',NULL)ON CONFLICT(stem,cadre)DO NOTHING;
