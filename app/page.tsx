...
const getPricing = (settings: PlatformSettings) => [
  ...
  },
  {
    ...
    features: ['200 practice questions/day', '7-day access', 'AI explanations', '3 mock exams (2 downloads)', 'Flashcards and analytics', 'Personalized revision plan included'],
