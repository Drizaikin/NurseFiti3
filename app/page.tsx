...
const getPricing = (settings: PlatformSettings) => [
  {
    ...
    features: ['20 practice questions/day', 'Readiness snapshot', 'Community study groups', 'Tutor booking access', 'Upgrade when you need full exam prep'],
    cta: 'Start Preparing',
    href: '/signup',
    highlight: false,
    badge: null,
  },
  {
    ...
    features: ['120 practice questions/day', 'AI explanations', '2 mock exams (1 download)', 'Readiness analytics', 'Flashcards'],
    cta: 'Boost Today',
    href: '/signup',
    highlight: false,
    badge: null,
  },
  {
    ...
    features: ['200 practice questions/day', '7-day access', 'AI explanations', '3 mock exams (2 downloads)', 'Flashcards and analytics', 'Personalized revision plan included', 'Download questions you answered incorrectly'],
  ...
  },
  {
    ...
    features: ['Unlimited MCQ practice', '3 mock exams/week (unlimited downloads)', 'Smarter analytics', 'Adaptive revision roadmap', 'Flashcards', 'Tutor priority', 'Download questions you answered incorrectly'],
  ...
  },
  {
    ...
    features: ['Everything in Success Plan', 'Unlimited mock exams & downloads', 'Tutor priority', 'Exam registration reminders', 'Download questions you answered incorrectly'],
    cta: 'Join Elite Prep',
    href: '/signup',
    highlight: false,
    badge: 'Best Value',
